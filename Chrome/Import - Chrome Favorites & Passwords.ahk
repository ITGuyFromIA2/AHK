...
MsgBox, After clicking OK, the following will happen:`n1) All Chrome windows for this user will be closed`n2) Mouse and Keyboard movement will be restricted until script completion.
...
ChromeFavFolder=%appLocal%\Google\Chrome\User Data\Default\
ChromeFavorites=BookMarks ;
ChromeFavoritesBak=BookMarks.bak

ChromeFav_Full=%ChromeFavFolder%%ChromeFavorites%
chromeFav_BAK_Full=%ChromeFavFolder%%ChromeFavoritesBak%

ChromeFav_FullBackup=%FinalPath%\%ChromeFavorites%
ChromeFav_BAK_FullBackup=%FinalPath%\%ChromeFavoritesBak%
...
;Start Chrome
	Run, "%app%" "https://google.com" --hide-crash-restore-bubble -enable-features=PasswordImport
...
MsgBox, Script has finished importing passwords and favorites.
Exit
